<?php
    ...
    try {
        if (!isset($_GET["name"])) {
            error_log("\n" . "Bad method used or repo name not set", 3, $_SERVER["DOCUMENT_ROOT"] . "/SAW/SAWFinalProject/texts/errorLog.txt");
        ...
        if (empty($repoName)) {
            error_log("\n" . "Repo name can't be empty", 3, $_SERVER["DOCUMENT_ROOT"] . "/SAW/SAWFinalProject/texts/errorLog.txt");
